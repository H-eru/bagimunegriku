				...
				<div class="main-content-inner">
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Ubah Data Indikator Nilai Karakter
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<?php
							...
							$query 			= mysqli_query($conn, "SELECT * FROM tbl_indikator_nikar WHERE id_indikator='$id_indikator'");
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="col-sm-9 widget-box widget-color-blue2">
											<div class="widget-header"> <h5 class="widget-title">Isikan Data Indikator NiKar dengan Teliti dan Benar</h5> </div>

											<form role="form" action="../update/update_indikator.php" method="POST" enctype="multipart/form-data" autocomplete="off">
												<div class="widget-body">
													<div class="widget-main padding-30">
														<input type="hidden" value="<?php echo $row['id_indikator']; ?>" name="id_indikator" readonly/>
																										
														<div class="form-group has-info">
															<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Aspek Indikator</label>

															<div class="col-xs-12 col-sm-5">
																<select name="aspek_indikator" class="form-control" required/>
																	<option value="<?php echo $row['aspek_indikator']; ?>"><?php echo $row['aspek_indikator']; ?></option>
																	<option value="Spiritualitas">Spiritualitas</option>
																	<option value="Akademik">Akademik</option>
																	<option value="Sikap Moral">Sikap Moral</option>
														...
														<div class="form-group has-info">
															<label for="inputInfo"  class="col-xs-12 col-sm-3 control-label no-padding-right">Keterangan Indikator</label>
															
															<div class="col-xs-12 col-sm-5">
																<textarea class="form-control" name="ket_indikator" rows="3" class="autosize-transition form-control"><?php echo $row['ket_indikator']; ?></textarea>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														</div>
													</div>
