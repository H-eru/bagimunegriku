				...
				<div class="main-content-inner">
					<div class="page-content">
						...
						<?php
							...
							$query 		= mysqli_query($conn, "SELECT * FROM tbl_pembina WHERE id_pembina='$id_pembina'");
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="col-sm-9 widget-box widget-color-blue2">
											<div class="widget-header"> <h5 class="widget-title">Isikan Data Pembina Asrama dengan Teliti dan Benar</h5> </div>

											<form role="form" action="../update/update_pembina.php" method="POST" enctype="multipart/form-data" autocomplete="off">
												<div class="widget-body">
													<div class="widget-main padding-8">
														<div class="form-group has-info">
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="hidden" value="<?php echo $row['id_pembina']; ?>" name="id_pembina" readonly/>
																</span>
															</div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" name="nama_pembina" value="<?php echo $row['nama_pembina']; ?>" class="width-100" required/>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<select name="jk_pembina" class="form-control" required/>
																	<option value="<?php echo $row['jk_pembina']; ?>">
																		<?php 
																			if($row['jk_pembina']=="L"){
																				echo "Laki-Laki";
																			}else{
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="date" name="ttl_pembina" value="<?php echo $row['ttl_pembina']; ?>" class="width-100" required/>
																		<i class="ace-icon fa fa-check-circle"></i>
																</span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" value="<?php echo $row['telp_pembina']; ?>" name="telp_pembina" class="form-control" pattern="^\d{4}-\d{4}-\d{4}$" placeholder="XXXX-XXXX-XXXX" required/>
																		<i class="ace-icon fa fa-check-circle"></i>
																</span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" value="<?php echo $row['alamat_pembina']; ?>" name="alamat_pembina" class="width-100" placeholder="Nama Jalan, RT / RW, Desa, Kec, Kota" required/>
																	<i class="ace-icon fa fa-check-circle"></i>
																<span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="">
																	...
																	<input type="hidden" value="<?php echo $row['foto_pembina']; ?>" name="foto">
																</span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														</div>
													...
													<div class="widget-toolbox padding-8 clearfix">
														<center>
															<div class="btn-group">
																...
																<a href="../tabel/tabelDataPembina.php" class="btn btn-sm btn-info" title="Back">KEMBALI</a>
															</div>
														</center>
													</div>
												</div>
