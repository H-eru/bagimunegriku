				...
				<div class="main-content-inner">
					<div class="page-content">
						...
						<?php
							...
							$query 			= mysqli_query($conn, "SELECT * FROM tbl_indikator_plg WHERE id_indikator_plg='$id_indikator_plg'");
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="col-sm-9 widget-box widget-color-blue2">
											<div class="widget-header"> <h5 class="widget-title">Isikan Data Indikator Pelanggaran dengan Teliti dan Benar</h5> </div>

											<form role="form" action="../update/update_indikator_plg.php" method="POST" enctype="multipart/form-data" autocomplete="off">
												<div class="widget-body">
													<div class="widget-main padding-30">
														<input type="hidden" value="<?php echo $row['id_indikator_plg']; ?>" name="id_indikator_plg" readonly/>
																										
														<div class="form-group has-info">
															<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Tingkat Pelanggaran</label>

															<div class="col-xs-12 col-sm-5">
																<select name="tingkat_plg" class="form-control" required/>
																	<option value="<?php echo $row['tingkat_plg']; ?>"><?php echo $row['tingkat_plg']; ?></option>
														...
														<div class="form-group has-info">
															<label for="inputInfo"  class="col-xs-12 col-sm-3 control-label no-padding-right">Keterangan Indikator Pelanggaran</label>
															
															<div class="col-xs-12 col-sm-5">
																<textarea class="form-control" name="ket_indikator_plg" rows="3" class="autosize-transition form-control"><?php echo $row['ket_indikator_plg']; ?></textarea>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														</div>
													</div>
