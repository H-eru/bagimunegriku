				...
				<div class="main-content-inner">
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Ubah Data Orang Tua/Wali Siswa
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<?php
							...
							$query 		= mysqli_query($conn, "SELECT * FROM tbl_ortu WHERE id_ortu='$id_ortu'");
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="col-sm-9 widget-box widget-color-blue2">
											<div class="widget-header"> <h5 class="widget-title">Isikan Data Orang Tua/Wali Siswa dengan Teliti dan Benar</h5> </div>

											<form role="form" action="../update/update_ortu.php" method="POST" enctype="multipart/form-data" autocomplete="off">
												<div class="widget-body">
													<div class="widget-main padding-20">
														<div class="form-group has-info">
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="hidden" value="<?php echo $row['id_ortu']; ?>" name="id_ortu" readonly/>
																</span>
															</div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" name="nama_ortu" value="<?php echo $row['nama_ortu']; ?>" class="width-100" required/>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<select name="jk_ortu" class="form-control" required/>
																	<option value="<?php echo $row['jk_ortu']; ?>">
																		<?php 
																			if($row['jk_ortu']=="L"){
																				echo "Laki-Laki";
																			}else{
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<select name="agama_ortu" class="form-control" required/>
																	<option value="<?php echo $row['agama_ortu']; ?>"><?php echo $row['agama_ortu']; ?></option>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" value="<?php echo $row['telp_ortu']; ?>" name="telp_ortu" class="form-control" pattern="^\d{4}-\d{4}-\d{4}$" placeholder="XXXX-XXXX-XXXX" required/>
																		<i class="ace-icon fa fa-check-circle"></i>
																</span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" value="<?php echo $row['alamat_ortu']; ?>" name="alamat_ortu" class="width-100" placeholder="Nama Jalan, RT / RW, Desa, Kec, Kota" required/>
																	<i class="ace-icon fa fa-check-circle"></i>
																<span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														...
														<div class="form-group has-info">
															<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Hubungan dg Anak</label>

															<div class="col-xs-12 col-sm-5">
																<select name="hub_dg_anak" class="form-control" required/>
																	<option value="<?php echo $row['hub_dg_anak']; ?>"><?php echo $row['hub_dg_anak']; ?></option>
														...
														<div class="form-group has-info">
															<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">NIS Siswa | <font color="green">*sesuai dg Kartu Pelajar</font></label>

															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" name="id_siswa" value="<?php echo $row['id_siswa']; ?>" class="width-100" required/>
																		<i class="ace-icon fa fa-check-circle"></i>
																</span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="">
																	...
																	<input type="hidden" value="<?php echo $row['foto_ortu']; ?>" name="foto">
																</span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														</div>
