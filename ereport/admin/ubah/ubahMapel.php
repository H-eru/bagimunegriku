				...
				<div class="main-content-inner">
					<div class="page-content">
						...
						<?php
							...
							$query 		= mysqli_query($conn, "SELECT * FROM tbl_mapel WHERE id_mapel='$id_mapel'");
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="col-sm-9 widget-box widget-color-blue2">
											...
											<form role="form" action="../update/update_mapel.php" method="POST" enctype="multipart/form-data" autocomplete="off">
												<div class="widget-body">
													<div class="widget-main padding-20">
														<div class="form-group has-info">
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="hidden" value="<?php echo $row['id_mapel']; ?>" name="id_mapel" readonly/>
																</span>
															</div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" name="nama_mapel" value="<?php echo $row['nama_mapel']; ?>" class="width-100" required/>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<select name="jenis_mapel" class="form-control" required/>
																	<option value="<?php echo $row['jenis_mapel']; ?>"><?php echo $row['jenis_mapel']; ?></option>
