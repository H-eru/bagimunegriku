								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Foto Profil" src="../pictures/6.jpg" />
												</span>
										...
										<div class="col-xs-12 col-sm-9">
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span id="nama"><?php echo $level['nama'];?></span>
													</div>
												</div>
											...
											<form action="../admin/update_username.php" method="POST" enctype="multipart/form-data" autocomplete="off">
												
												<input type="hidden" name="id_user" value="<?php echo $level['id_user'];?>" readonly />
											...
											<form action="../admin/update_password.php" method="POST" enctype="multipart/form-data" autocomplete="off">
