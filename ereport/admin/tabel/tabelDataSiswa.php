				...
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							...
							<form action="../tabel/tabelDataSiswa.php" method="post">	
								<div class="form-group has-info">
									<label for="inputInfo" class="col-sm-1 control-label no-padding-right">Pilih Kelas : </label>
								...
								<div class="table-header">
									<font size="4 px">Data Siswa</font>
								</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th width="150px" class="center">NIS</th>
														<th width="150px" class="center">Nama</th>
														<th width="120px" class="center">Jenis Kelamin</th>
														<th width="150px" class="center">Telepon / WA</th>
														<th width="80px"  class="center">Agama</th>
														<th width="250px" class="center">Alamat</th>
														<th width="100px" class="center">Foto</th>
														<th class="center">Aksi Data</th>														
													</tr>
												</thead>
												...
												<?php
													...
													if(!isset($_POST['kelas_siswa']) || $_POST['kelas_siswa'] == '-'){
														$query = mysqli_query($conn, "SELECT * FROM tbl_siswa");
													}else{	
														$kelas = $_POST['kelas_siswa'];
															if($kelas){
																$query = mysqli_query($conn, "SELECT * FROM tbl_siswa WHERE kelas_siswa = '$kelas'");
															}
													}
													...
													?>
														...
														<tr>
															...
															<td width="150px">
																<?php echo $rerow['id_siswa'];?>
															</td>
															<td width="150px">
																<?php echo $rerow['nama_siswa'];?>
															</td>
															<td width="120px">
																<?php 
																	if($rerow['jk_siswa']=="L"){
															...
															<td width="150px"><?php echo $rerow['telp_siswa'];?></td>
															<td width="80px"><?php echo $rerow['agama_siswa'];?></td>
															
															<td width="250px"><?php echo $rerow['alamat_siswa'];?></td>
															<td width="100px"><img src="../../FotoSiswa/<?php echo $rerow['foto_siswa'];?>" width='50px'></td>
															
															<td class="center">
																<a class="btn btn-sm btn-success" href='../ubah/ubahSiswa.php?id_siswa=<?php echo $rerow['id_siswa'];?>'>
																<i class="ace-icon fa fa-pencil bigger-120 align-top icon-on-right"></i> Ubah</a>
																	
																<a class="btn btn-sm btn-danger" href='../hapus/deleteSiswa.php?id_siswa=<?php echo $rerow['id_siswa'];?>' onClick='return konfrim()'>
						...
						<div class="row">
							&emsp;
							Untuk mengupload foto klik tombol <i class="ace-icon fa fa-arrow-right icon-on-right"></i>&nbsp;
							<a class="btn btn-sm btn-purple" href='../tabel/tabelUploadFoto.php'>
								<label>Upload</label><i class="ace-icon fa fa-cloud-upload align-top bigger-120 icon-on-right"></i>
							</a>
						</div>
					</div><!-- /.page-content -->
				</div>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				.DataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					  null, null,null, null, null, null, null,/* Menandakan berapa bnyk kolom yang dpt ditampung di tabel, jumlahnya
