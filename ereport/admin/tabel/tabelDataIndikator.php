						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Tabel Data Indikator Nilai Karakter
								</small>
							</h1>
						</div><!-- /.page-header -->
							...
							<div class="col-xs-10">
								...
								<div class="clearfix">
										...
										<div class="table-header">
											<font size="4px">Data Indikator Nikar</font>
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center"><font size="3px">Aspek Indikator NiKar</font></th>
														<th class="center"><font size="3px">Keterangan Indikator NiKar</font></th>
												...
												<tr>
													...
													<td width="200px">
														<font size="3px"><?php echo $rerow['aspek_indikator'];?></font>
													</td>
													<td>
														<font size="3px"><?php echo $rerow['ket_indikator'];?></font>
													</td>
													<td class="center">
														<a class="btn btn-sm btn-success" href='../ubah/ubahIndikator.php?id_indikator=<?php echo $rerow['id_indikator'];?>'>
														<i class="ace-icon fa fa-pencil bigger-120 align-top icon-on-right"></i> Ubah</a>
															
														<a class="btn btn-sm btn-danger" href='../hapus/deleteIndikator.php?id_indikator=<?php echo $rerow['id_indikator'];?>' onClick='return konfrim()'>
