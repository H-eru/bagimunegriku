						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Tabel Data Orang Tua / Wali Siswa
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="table-header">
									<font size="4 px">Data Orang Tua Siswa</font>
								</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th width="180px" class="center">Nama Orang Tua/Wali</th>
														<th width="120px" class="center">Jenis Kelamin</th>
														<th width="80px" class="center">Agama</th>
														<th width="150px" class="center">Telepon / WA</th>
														<th width="200px" class="center">Alamat</th>
														<th width="120px" class="center">NIS Siswa</th>
														<th width="150px" class="center">Hubungan_dg_anak</th>
												...
												<?php
													...
													$query = mysqli_query($conn, "SELECT * FROM tbl_ortu");
												...
												<tr>
														...
														<td width="100px"><img src="../../pictures/<?php echo $rerow['foto_ortu'];?>" width='50px'></td>
														<td width="180px">
															<?php echo $rerow['nama_ortu'];?>
														</td>
														<td width="120px">
															<?php 
																if($rerow['jk_ortu']=="L"){
														...
														<td width="80px"><?php echo $rerow['agama_ortu'];?></td>
														<td width="150px"><?php echo $rerow['telp_ortu'];?></td>
														<td width="200px"><?php echo $rerow['alamat_ortu'];?></td>
														<td width="120px"><?php echo $rerow['id_siswa'];?></td>
														<td width="150px"><?php echo $rerow['hub_dg_anak'];?></td>
														<td class="center">
															<a class="btn btn-sm btn-success" href='../ubah/ubahOrtu.php?id_ortu=<?php echo $rerow['id_ortu'];?>'>
															<i class="ace-icon fa fa-pencil bigger-120 align-top icon-on-right"></i> Ubah</a>
																
															<a class="btn btn-sm btn-danger" href='../hapus/deleteOrtu.php?id_ortu=<?php echo $rerow['id_ortu'];?>' onClick='return konfrim()'>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				.DataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					  null, null,null, null, null, null,null, null,/* Menandakan berapa bnyk kolom yang dpt ditampung di tabel, jumlahnya
