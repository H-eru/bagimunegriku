							...
							<div class="col-xs-12">
								...
								<div class="clearfix">
										...
										<div class="table-header">
											<font size="4px">Data Kop / Header</font>
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th width="150px" class="center">Nama Yayasan</th>
														<th width="150px" class="center">Nama Instansi</th>
														<th width="200px" class="center">Alamat Instansi</th>
														<th width="120px" class="center">Telepon Instansi</th>
														<th width="60px" class="center">Email Instansi</th>
														<th width="200px" class="center">Rekening Instansi</th>
														<th width="120px" class="center">Logo Instansi</th>
												...
												<?php
													...
													$query = mysqli_query($conn, "SELECT * FROM tbl_kop");
												...
												<tr>
													...
													<td width="150px">
														<?php echo $rerow['nama_yayasan'];?>
													</td>
													<td width="150px">
														<?php echo $rerow['nama_instansi'];?>
													</td>
													<td width="200px">
														<?php echo $rerow['alamat_instansi'];?>
													</td>
													<td width="120px">
														<?php echo $rerow['telp_instansi'];?>
													</td>
													<td width="60px">
														<?php echo $rerow['email_instansi'];?>
													</td>
													<td width="200px">
														<?php echo $rerow['rek_instansi'];?>
													</td>
													<td width="120px">
														<img src="../../pictures/<?php echo $rerow['logo'];?>" width='50px'>
													</td>
													<td class="center">
														<a class="btn btn-sm btn-success" href='../ubah/ubahKop.php?id_kop=<?php echo $rerow['id_kop'];?>'>
														<i class="ace-icon fa fa-pencil bigger-120 align-top icon-on-right"></i> Ubah</a>
															
														<a class="btn btn-sm btn-danger" href='../hapus/deleteKop.php?id_kop=<?php echo $rerow['id_kop'];?>' onClick='return konfrim()'>
