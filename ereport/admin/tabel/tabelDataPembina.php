							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
										...
										<div class="table-header">
											<font size="4 px">Data Pembina Asrama</font>
										</div>
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<font size="2px">
															...
															<th width="200px" class="center">Nama Pembina</th>
															<th width="120px" class="center">Jenis Kelamin</th>
															<th width="120px" class="center">Tanggal Lahir</th>
															<th width="120px" class="center">Telepon / WA</th>
															<th width="300px" class="center">Alamat</th>
												...
												<?php
													...
													$query = mysqli_query($conn, "SELECT * FROM tbl_pembina");
												...
												<tr>
													...
													<td width="100px"><img src="../../pictures/<?php echo $rerow['foto_pembina'];?>" width='50px'></td>	
													
													<td width="200px">
														<?php echo $rerow['nama_pembina'];?>
													</td>
													<td width="120px">
														<?php 
															if($rerow['jk_pembina']=="L"){
																echo "Laki-Laki";
															}else{
																echo "Perempuan";
															};
													...
													<td width="120px"><?php echo $rerow['ttl_pembina'];?></td>
													<td width="120px"><?php echo $rerow['telp_pembina'];?></td>
													<td width="300px"><?php echo $rerow['alamat_pembina'];?></td>
													
													<td class="center">
														<a class="btn btn-sm btn-success" href='../ubah/ubahPembina.php?id_pembina=<?php echo $rerow['id_pembina'];?>'>
														<i class="ace-icon fa fa-pencil bigger-120 align-top icon-on-right"></i> Ubah</a>
															
														<a class="btn btn-sm btn-danger" href='../hapus/deletePembina.php?id_pembina=<?php echo $rerow['id_pembina'];?>' onClick='return konfrim()'>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				.DataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					  null, null,null, null, null, null,/* Menandakan berapa bnyk kolom yang dpt ditampung di tabel, jumlahnya
