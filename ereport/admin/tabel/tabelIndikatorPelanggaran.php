						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Tabel Data Indikator Pelanggaran
								</small>
							</h1>
						</div><!-- /.page-header -->
								...
								<!-- PAGE CONTENT BEGINS -->
									<div class="clearfix">
										...
										<div class="table-header">
											<font size="4px">Data Indikator Pelanggaran</font>
										</div>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th class="center"><font size="3px">Keterangan Indikator Pelanggaran</font></th>
														<th class="center"><font size="3px">Tingkat Pelanggaran</font></th>
												...
												<?php
													...
													$query = mysqli_query($conn, "SELECT * FROM tbl_indikator_plg");
												...
												<tr>
													...
													<td>
														<font size="3px"><?php echo $rerow['ket_indikator_plg'];?></font>
													</td>
													<td class="center" width="200px">
														<font size="3px"><?php echo $rerow['tingkat_plg'];?></font>
													</td>
													<td class="center">
														<a class="btn btn-sm btn-success" href='../ubah/ubahIndikatorPelanggaran.php?id_indikator_plg=<?php echo $rerow['id_indikator_plg'];?>'>
														<i class="ace-icon fa fa-pencil bigger-120 align-top icon-on-right"></i> Ubah</a>
															
														<a class="btn btn-sm btn-danger" href='../hapus/deleteIndikatorPelanggaran.php?id_indikator_plg=<?php echo $rerow['id_indikator_plg'];?>' onClick='return konfrim()'>
