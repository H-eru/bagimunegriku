				...
				<div class="main-content-inner">
					<div class="page-content">
						...
						<div class="row">
							...
							<form action="../tabel/tabelUploadFoto.php" method="post">	
								<div class="form-group has-info">
									<label for="inputInfo" class="col-sm-1 control-label no-padding-right">Kelas : </label>
								...
								<div class="table-header">
									<font size="4px">Data Siswa</font>
								</div>

								<div>
					<form method="POST" action="../input/input_foto_siswa.php" enctype="multipart/form-data">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														<th width="50px" class="center">
															<label class="pos-rel">
																<input type="checkbox" name="cek" class="ace" />
																<span class="lbl"></span>
															</label>
														</th>
														
														<th width="150px" class="center"><font size="3px">NIS</font></th>
														<th width="150px" class="center"><font size="3px">Nama</font></th>
														
														<th class="center"><font size="3px">Pilih Foto Baru</font></th>														
													</tr>
												</thead>
												...
												<?php
													...
													if(!isset($_POST['kelas_siswa']) || $_POST['kelas_siswa'] == '-'){
														$query = mysqli_query($conn, "SELECT id_siswa,nama_siswa,foto_siswa FROM tbl_siswa");
													}else{	
													...
													?>
														...
														<tr>
															...
															<td class="center" width="150px">
																<font size="3px"><?php echo $rerow['id_siswa'];?></font>
															</td>
															<td class="center" width="150px">
																<font size="3px"><?php echo $rerow['nama_siswa'];?></font>
															</td>
															
															<td class="center">
																<input type="hidden" name="id_siswa_<?=$no;?>" value="<?php echo $rerow['id_siswa'];?>">
						...
						<div class="space"></div>
						<div class="col-xs-8"><p align="right">
							<input type="hidden" name="banyak_data" value="<?php echo $no;?>">
							<button class="btn btn-white btn-pink btn-bold">
								<i class="ace-icon fa fa-cloud-upload bigger-120 pink"></i><label>Upload</label>
							</button>
						</p></div>
					</form>
					</div><!-- /.page-content -->
