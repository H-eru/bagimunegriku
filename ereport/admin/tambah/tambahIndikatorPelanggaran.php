						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Tambah Data Indikator Pelanggaran
								</small>
							</h1>
						</div><!-- /.page-header -->
							...
							<div class="col-xs-12">
								...
								<div class="col-sm-9 widget-box widget-color-blue2">
									<div class="widget-header"> <h5 class="widget-title">Isikan Data Indikator Pelanggaran dengan Teliti dan Benar</h5> </div>
											...
											<form role="form" action="../input/input_indikator_plg.php" method="POST" enctype="multipart/form-data" autocomplete="off">
												<div class="widget-body">
													<div class="widget-main padding-30">
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<textarea class="form-control" name="ket_indikator_plg" rows="3" class="autosize-transition form-control" required/></textarea>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														</div>
