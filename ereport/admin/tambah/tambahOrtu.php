						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="col-sm-9 widget-box widget-color-blue2">
											<div class="widget-header"> <h5 class="widget-title">Isikan Data Orang Tua dengan Teliti dan Benar</h5> </div>

											<form role="form" action="../input/input_ortu.php" method="POST" enctype="multipart/form-data" autocomplete="off">
												<div class="widget-body">
													<div class="widget-main padding-20">
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" name="nama_ortu" class="width-100" required/>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="block input-icon input-icon-right">
																	<input type="text" name="telp_ortu" class="form-control" pattern="^\d{4}-\d{4}-\d{4}$" placeholder="XXXX-XXXX-XXXX" required/>
																		<i class="ace-icon fa fa-check-circle"></i>
																</span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<textarea class="form-control" name="alamat_ortu" rows="3" placeholder="Nama Jalan, RT / RW, Desa, Kec, Kota" class="autosize-transition form-control"></textarea>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														</div>
														...
														<div class="form-group has-info">
															...
															<div class="col-xs-12 col-sm-5">
																<span class="">
																	<input type="file" name="foto_ortu" class="width-100" required/>
																</span>
															</div>
															<div class="help-block col-xs-12 col-sm-reset inline"></div>
														</div>
