							...
							<div class="col-xs-12">
								...
								<div class="col-sm-9 widget-box widget-color-blue2">
									<div class="widget-header">
										<h5 class="widget-title">Isikan Data Pembina Asrama dengan Teliti dan Benar</h5>
									</div>

									<form role="form" action="../input/input_pembina.php" method="POST" enctype="multipart/form-data" autocomplete="off">
										<div class="widget-body">
											<div class="widget-main padding-20">
												<div class="form-group has-info">
													<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Nama Pembina</label>

													<div class="input-group col-xs-12 col-sm-5">
														<input type="text" name="nama_pembina" class="width-100" required />
														<span class="input-group-addon btn-info">
															<i class="ace-icon fa-fw fa fa-user bigger-120 white"></i>
														</span>
													</div>
												...
												<div class="form-group has-info">
													...
													<div class="input-group col-xs-12 col-sm-5">
														<select name="jk_pembina" class="form-control" required />
												...
												<div class="form-group has-info">
													<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">TTL Pembina</label>

													<div class="input-group col-xs-12 col-sm-5">
														<input class="form-control date-picker width-100" name="ttl_pembina" type="text" data-date-format="dd-mm-yyyy" />
														<span class="input-group-addon btn-info">
															<i class="ace-icon fa-fw fa fa-calendar bigger-120 white"></i>
														</span>
													</div>
												...
												<div class="form-group has-info">
													<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Alamat Pembina</label>

													<div class="input-group col-xs-12 col-sm-5">
														<input type="text" name="alamat_pembina" class="form-control width-100" placeholder="Nama Jalan, RT / RW, Desa, Kec, Kota" required />
														<span class="input-group-addon btn-info">
															<i class="ace-icon fa-fw fa fa-home bigger-120 white"></i>
														</span>
													</div>
													<div class="help-block col-xs-12 col-sm-reset inline"></div>
												</div>
												...
												<div class="form-group has-info">
													...
													<div class="input-group col-xs-12 col-sm-5">
														<input type="text" name="telp_pembina" class="form-control width-100" pattern="^\d{4}-\d{4}-\d{4}$" placeholder="XXXX-XXXX-XXXX" required />
														<span class="input-group-addon btn-info">
															<i class="ace-icon fa-fw fa fa-phone bigger-120 white"></i>
														</span>
													</div>
													<div class="help-block col-xs-12 col-sm-reset inline"></div>
												</div>
												...
												<div class="form-group has-info">
													...
													<div class="input-group col-xs-12 col-sm-5">
														<input type="text" name="username" class="form-control width-100" required />
														<span class="input-group-addon btn-info">
															<i class="ace-icon fa-fw fa fa-user bigger-120 white"></i>
														</span>
													</div>
												...
												<div class="form-group has-info">
													...
													<div class="input-group col-xs-12 col-sm-5">
														<input type="password" name="password" class="form-control width-100" required />
														<span class="input-group-addon btn-info">
															<i class="ace-icon fa-fw fa fa-lock bigger-120 white"></i>
														</span>
													</div>
													<div class="help-block col-xs-12 col-sm-reset inline"></div>
												</div>
												...
												<div class="form-group has-info">
													<label for="inputInfo" class="col-xs-12 col-sm-3 control-label no-padding-right">Re - Password</label>

													<div class="input-group col-xs-12 col-sm-5">
														<input type="password" name="re_password" class="width-100" placeholder="Ketikkan ulang password Anda di sini" required />
														<span class="input-group-addon btn-info">
															<i class="ace-icon fa-fw fa fa-lock bigger-120 white"></i>
														</span>
													</div>
												...
												<div class="form-group has-info">
													...
													<div class="input-group col-xs-12 col-sm-5">
														<span class="">
															<input type="file" name="foto_pembina" class="width-100" required />
														</span>
													</div>
													<div class="help-block col-xs-12 col-sm-reset inline"></div>
												</div>
												...
												<center>
													<div class="btn-group">
														<button type="submit" class="btn btn-sm btn-purple">
															<i class="ace-icon fa-fw fa fa-floppy-o bigger-125"></i>
															Simpan
														</button>
													</div>
												</center>
