						...
						<div class="row">
							<div class="col-md-8">
								...
								<?php
									...
									$query	 = mysqli_query($conn, "SELECT * FROM tbl_cat_khusus_siswa,tbl_ortu,tbl_siswa WHERE 
												tbl_cat_khusus_siswa.id_siswa = '$id_siswa' AND tbl_siswa.id_siswa='$id_siswa'
												AND tbl_ortu.id_siswa = '$id_siswa'");
								...
								<div class="table-header">
									<font size="3px">Lihat Catatan Khusus Siswa <font color="yellow"><?php echo $result['nama_siswa']; ?></font></font>
								</div>
								<div>
									...
									<tr>
										<th width="20px" class="center">
											<label class="pos-rel"><font size="3px"><b>No</b></font>
											<span class="lbl"></span>
											</label>
										</th>
										<th width="150px" class="center"><font size="3px">Tanggal Input</font></th>
										<th class="center"><font size="3px">Keterangan Catatan</font></th>
									</tr>
									</thead>
									<?php
													$id_siswa = $level['id_siswa'];
													$query = mysqli_query($conn, "SELECT * FROM tbl_cat_khusus_siswa, tbl_siswa, tbl_ortu 
															WHERE tbl_cat_khusus_siswa.id_siswa='$id_siswa' AND tbl_siswa.id_siswa='$id_siswa'
															AND tbl_ortu.id_siswa='$id_siswa'");
												...
												<tr>
													...
													<td width="150px" class="center">
														<font size="3px"><?php echo $rerow['tgl_input'];?></font>
													</td>
													<td class="center">
														<font size="3px"><?php echo $rerow['ket_catatan'];?></font>
													</td>
												</tr>
			...
			jQuery(function($) {
			 ...
			 //.wrap("<div class='dataTables_borderWrap' />")   //if you are applying horizontal scrolling (sScrollX)
				.DataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					  null,/* Menandakan berapa bnyk kolom yang dpt ditampung di tabel, jumlahnya
