					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form role="form" onSubmit="return validateForm()" action="../ortu/lihatAkademik.php" method="POST" enctype="multipart/form-data">
									<div class="col-md-2">
										<label>Pilih Jenis Nilai</label>
											<select class="form-control" name="jenis_nilai" required/>
												<option>-</option>
												<?php
													$r=mysqli_query($conn,"select * from tbl_jenis_nilai");
														while($d=mysqli_fetch_assoc($r)){
															echo"<option>$d[ket_jenis_nilai]</option>";
														}
													?>
											</select>
									</div>
									<div class="col-md-2">
										<label>Pilih Mata Pelajaran</label>
											<select class="form-control" name="mapel" required/>
												<option>-</option>
												<?php
													$r=mysqli_query($conn,"select * from tbl_mapel");
														while($d=mysqli_fetch_assoc($r)){
															echo"<option>$d[nama_mapel]</option>";
														}
													?>
											</select>
									</div>
								...
								<div class="col-md-12">
									...
									<?php
										...
										if(!isset($_POST['mapel']) || $_POST['mapel'] == '-'  || !isset($_POST['jenis_nilai']) || $_POST['jenis_nilai'] == '-'){	
												echo "<h4><font color='red'>Mohon Inputkan Pilihan <b><u>Kelas</u></b> dan <b><u>Jenis Nilai</u></b> yang Sesuai!</font></h4>";
										}else{
											$jenis_nilai 	= $_POST['jenis_nilai'];
											$mapel 			= $_POST['mapel'];
											$id_siswa		= $level['id_siswa'];
											
											$queryx	 = mysqli_query($conn, "SELECT * FROM tbl_niak,tbl_ortu,tbl_siswa WHERE 
														tbl_niak.jenis_nilai='$jenis_nilai' AND tbl_niak.mapel='$mapel'
														AND tbl_niak.id_siswa = '$id_siswa' AND tbl_siswa.id_siswa='$id_siswa'");
											$resultx = mysqli_fetch_assoc($queryx);
									...
									<form action="../export/export_pdf_niak.php">
									<div class="table-header">
										<font size="3px">Tabel Data Nilai <font color="yellow"><?php echo $jenis_nilai ." ". $mapel; ?> </font> 
											|| Siswa <font color="yellow"><?php echo $resultx['nama_siswa']; ?></font></font>
									</div>
									
									<input type="hidden" name="jenis_nilais" value="<?php echo $jenis_nilai; ?>">
									<input type="hidden" name="mpl" value="<?php echo $mapel; ?>">
									<input type="hidden" name="id_siswas" value="<?php echo $id_siswa; ?>">
											...
											<tbody>
												<?php 
													$query	 = mysqli_query($conn, "SELECT * FROM tbl_niak,tbl_ortu,tbl_siswa WHERE 
														tbl_niak.jenis_nilai='$jenis_nilai' AND tbl_niak.mapel='$mapel'
														AND tbl_niak.id_siswa ='$id_siswa' AND tbl_ortu.id_siswa='$id_siswa'
														AND tbl_siswa.id_siswa='$id_siswa'");
									...
									<input type="submit" value="Download PDF" class="btn btn-info">
									</form>
			...
			jQuery(function($) {
			 ...
			 //.wrap("<div class='dataTables_borderWrap' />")   //if you are applying horizontal scrolling (sScrollX)
				.DataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					  null, null, null,/* Menandakan berapa bnyk kolom yang dpt ditampung di tabel, jumlahnya
