								...
								<div>
									<div id="user-profile-1" class="user-profile row">
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Foto Profil" src="../pictures/<?php echo $level['foto_ortu']; ?>" />
												</span>
										...
										<div class="col-xs-12 col-sm-9">
											...
											<form action="../ortu/update_ortu.php" method="POST" enctype="multipart/form-data" autocomplete="off">	
												<input type="hidden" name="id_ortu" value="<?php echo $level['id_ortu'];?>" readonly />
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-9 profile-info-value">
														<span id="nama"><?php echo $level['nama_ortu'];?></span>
													</div>
												</div>
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-9">
														<select id="form-input-select" name="jk_ortu" class="col-sm-5" disabled />
															<option value="<?php echo $level['jk_ortu']; ?>">
																<?php 
																	if($level['jk_ortu']=="L"){
																		echo "Laki-Laki";
																	}else{
														...
														<input type="hidden" name="jk_ortu" value="<?php echo $level['jk_ortu']; ?>">
														&emsp;
														<label class="middle">
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-9">
														<select id="form-input-select-2" name="agama_ortu" class="col-sm-5" disabled >
															<option value="<?php echo $level['agama_ortu']; ?>"><?php echo $level['agama_ortu']; ?></option>
														...
														<input type="hidden" name="agama_ortu" value="<?php echo $level['agama_ortu']; ?>">
														&emsp;
														<label class="middle">
															<input class="ace" type="checkbox" id="id-disable-select-2"/>
															<span class="lbl"> Centang untuk Ubah</span>
														</label>
													</div>
												</div>
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-9">
														<select id="form-input-select-3" name="hub_dg_anak" class="col-sm-5" disabled >
															<option value="<?php echo $row['hub_dg_anak']; ?>"><?php echo $level['hub_dg_anak']; ?></option>
														...
														<input type="hidden" name="hub_dg_anak" value="<?php echo $level['hub_dg_anak']; ?>">
														&emsp;
														<label class="middle">
															<input class="ace" type="checkbox" id="id-disable-select-3"/>
															<span class="lbl"> Centang untuk Ubah</span>
														</label>
													</div>
												</div>
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-9">
														<input type="text" name="telp_ortu" class="col-xs-10 col-sm-5" value="<?php echo $level['telp_ortu'];?>" id="form-input-readonly" pattern="^\d{4}-\d{4}-\d{4}$" placeholder="XXXX-XXXX-XXXX" readonly />
														&emsp;
														<label class="middle">
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-5">
														<textarea name="alamat_ortu" rows="3" placeholder="Nama Jalan, RT / RW, Desa, Kec, Kota" class="autosize-transition form-control" id="form-input-readonly-2" readonly /><?php echo $level['alamat_ortu'];?></textarea>
												...
												<div class="col-sm-12">
													...
													<div class="col-sm-9">
														<input type="file" name="foto_ortu" class="width-100">
														<input type="hidden" value="<?php echo $level['foto_ortu']; ?>" name="foto">
													</div>
												</div>
											...
											<form action="../ortu/update_username.php" method="POST" enctype="multipart/form-data" autocomplete="off">
											...
											<form action="../ortu/update_password.php" method="POST" enctype="multipart/form-data" autocomplete="off">
...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('#id-disable-select-2').on('click', function() {
					var inp = $('#form-input-select-2').get(0);
					if(inp.hasAttribute('disabled')) {
						inp.setAttribute('enabled' , 'true');
						inp.removeAttribute('disabled');
				...
				$('#id-disable-select-3').on('click', function() {
					var inp = $('#form-input-select-3').get(0);
					if(inp.hasAttribute('disabled')) {
						inp.setAttribute('enabled' , 'true');
						inp.removeAttribute('disabled');
