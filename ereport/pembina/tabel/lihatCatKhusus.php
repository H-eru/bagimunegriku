			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Lihat Data Catatan Khusus Siswa
								</small>
							</h1>
						</div><!-- /.page-header -->
						...
						<?php
							$id_cat = $_GET['id_cat'];
							$query2	= mysqli_query($conn,"select * from tbl_cat_khusus_siswa,tbl_siswa where 
										tbl_cat_khusus_siswa.id_cat='$id_cat' AND tbl_cat_khusus_siswa.id_siswa=tbl_siswa.id_siswa");
							$row2 	= mysqli_fetch_assoc($query2);
							
							$tgl = date('d F Y', strtotime($row2['tgl_input']));
						?>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="col-md-8 widget-box widget-color-blue2">
											<div class="widget-header"> <h5 class="widget-title">Lihat Data Catatan Khusus Siswa</h5> </div>

												<div class="widget-body">
													<div class="widget-main padding-20">
														<div class="col-md-6">
															<h4>Nama Siswa : <?php echo $row2['nama_siswa']?></h4>
															<input type="hidden" name="id_cat" value="<?=$id_cat;?>"  readonly />
														</div>
													...
													<div class="widget-main padding-20">
														<div class="col-md-10">
															<table>
																<tr>
																	<td width="120px"><font size="3px"><b>Tanggal</b> Input </font></td>
																	<td><font size="3px">&nbsp; : &nbsp;</font></td>
																	<td width="700px"><font size="3px"><b><?php echo $tgl; ?></b></font></td>
																</tr>
																<tr>
																	<td width="120px"><font size="3px"><b>Detail</b> Catatan Khusus</font></td>
																	<td width="10px"><font size="3px">&nbsp;&nbsp;</font></td>
																	<td width="700px"><font size="3px"><b><?php echo $row2['ket_catatan']; ?></b></font></td>
																</tr>
															</table>
													...
													<center>
														<div class="col-md-10">
															<a href="../tabel/tabelDataCatKhusus.php" class="btn btn-sm btn-pink" title="Kembali"><i class="ace-icon fa fa-reply"></i> KEMBALI</a>
														</div>
													</center>
