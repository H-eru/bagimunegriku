						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									Lihat Data Nilai Karakter Siswa
								</small>
							</h1>
						</div><!-- /.page-header -->

						<?php
							$id_nikar = $_GET['id_nikar'];
							$query = mysqli_query($conn, "SELECT * FROM tbl_indikator_nikar");
							$query2=mysqli_query($conn,"select * from tbl_nikar,tbl_siswa where tbl_nikar.id_nikar='$id_nikar' AND tbl_nikar.id_siswa=tbl_siswa.id_siswa");
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="col-md-8 widget-box widget-color-blue2">
											<div class="widget-header"> <h5 class="widget-title">Lihat Data Nilai Karakter Siswa</h5> </div>

												<div class="widget-body">
													<div class="widget-main padding-20">
														<div class="col-md-6">
															<h4>Nama Siswa : <?php echo $row2['nama_siswa']?></h4>
															<input type="hidden" name="id_nikar" value="<?=$id_nikar;?>"  readonly />
														</div>
													</div>	
													<div class="widget-main padding-20">
														<div class="col-md-10">
																	...
																	?>
																		<tr class="info">
																			...
																			<td width="100px" align="center">
																				<font size="3px"><?=$row2['nilai'.$i++];?></font>
																			</td>
																		</tr>
																		<?php
																			$angka+=1;															
													...
													<center>
														<div class="col-md-10">
															<a href="../tabel/tabelDataNikar.php" class="btn btn-sm btn-pink" title="Kembali"><i class="ace-icon fa fa-reply"></i> KEMBALI</a>
														</div>
													</center>
