							...
							<div class="col-xs-12">
								...
								<table>
									<tr>
										...
										<h4 class="text-danger">Pembina dalam sistem ini memiliki hak akses untuk :</h4>
											<h5><ul class="list-unstyled spaced">
												<hr>
												<li class="text-success" align="justify">
													<i class="ace-icon fa fa-check bigger-110 blue"></i>
													Mengelola data Pelanggaran Siswa, dimana Pembina Asrama mencatat tindakan siswa yang tidak sesuai dengan aturan yang ada
												</li>
												<hr>
												<li class="text-primary" align="justify">
													<i class="ace-icon fa fa-check bigger-110 green"></i>
													Mengelola data Catatan Khusus Siswa, dimana Pembina Asrama akan mendokumentasikan hal-hal "istimewa" yang dimiliki oleh anak-anak tertentu, berikut tindakan penanganan yang di lakukan
												</li>
												<hr>
												<li class="text-success" align="justify">
													<i class="ace-icon fa fa-check bigger-110 blue"></i>
													Mengelola data Nilai Karakter Siswa, dilakukan pada saat penilaian tengah dan akhir semester
												</li>
												<hr>
												<li class="text-primary" align="justify">
													<i class="ace-icon fa fa-check bigger-110 green"></i>
													Mengelola data Nilai Akademik Siswa, yaitu nilai ulangan harian, penilaian tengah semester dan akhir semester
												</li>
											</ul></h5>
										</td>
										<td width="30px">&emsp;</td>
										<td><img src="../pictures/fungsionalitas_pembina.jpg" width="600px"></td>
									</tr>
								</table>
